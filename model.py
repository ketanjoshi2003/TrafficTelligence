...
# Load dataset
data = pd.read_csv(r"C:\Users\Ketan\Project\TrafficTelligence-Advanced-Traffic-Volume-Estimation-with-Machine-Learning-main\TrafficTelligence-Advanced-Traffic-Volume-Estimation-with-Machine-Learning-main\traffic_volume.csv")
